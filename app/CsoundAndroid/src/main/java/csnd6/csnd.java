...
public class csnd implements csndConstants {
  ...
  public static int csoundCompileTreeAsync(SWIGTYPE_p_CSOUND_ csound, TREE root) {
    return csndJNI.csoundCompileTreeAsync(SWIGTYPE_p_CSOUND_.getCPtr(csound), TREE.getCPtr(root), root);
  }
  ...
  public static int csoundCompileOrcAsync(SWIGTYPE_p_CSOUND_ csound, String str) {
    return csndJNI.csoundCompileOrcAsync(SWIGTYPE_p_CSOUND_.getCPtr(csound), str);
  }

  public static double csoundEvalCode(SWIGTYPE_p_CSOUND_ csound, String str) {
  ...
  public static int csoundCompileCsd(SWIGTYPE_p_CSOUND_ csound, String csd_filename) {
    return csndJNI.csoundCompileCsd(SWIGTYPE_p_CSOUND_.getCPtr(csound), csd_filename);
  }

  public static int csoundCompileCsdText(SWIGTYPE_p_CSOUND_ csound, String csd_text) {
    return csndJNI.csoundCompileCsdText(SWIGTYPE_p_CSOUND_.getCPtr(csound), csd_text);
  }
  ...
  public static int csoundUDPServerStart(SWIGTYPE_p_CSOUND_ csound, long port) {
    return csndJNI.csoundUDPServerStart(SWIGTYPE_p_CSOUND_.getCPtr(csound), port);
  }

  public static int csoundUDPServerStatus(SWIGTYPE_p_CSOUND_ csound) {
    return csndJNI.csoundUDPServerStatus(SWIGTYPE_p_CSOUND_.getCPtr(csound));
  }

  public static int csoundUDPServerClose(SWIGTYPE_p_CSOUND_ csound) {
    return csndJNI.csoundUDPServerClose(SWIGTYPE_p_CSOUND_.getCPtr(csound));
  }

  public static int csoundUDPConsole(SWIGTYPE_p_CSOUND_ csound, String addr, int port, int mirror) {
    return csndJNI.csoundUDPConsole(SWIGTYPE_p_CSOUND_.getCPtr(csound), addr, port, mirror);
  }

  public static void csoundStopUDPConsole(SWIGTYPE_p_CSOUND_ csound) {
    csndJNI.csoundStopUDPConsole(SWIGTYPE_p_CSOUND_.getCPtr(csound));
  }

  public static double csoundGetSr(SWIGTYPE_p_CSOUND_ arg0) {
    return csndJNI.csoundGetSr(SWIGTYPE_p_CSOUND_.getCPtr(arg0));
  }

  public static double csoundGetKr(SWIGTYPE_p_CSOUND_ arg0) {
  ...
  public static double csoundGet0dBFS(SWIGTYPE_p_CSOUND_ arg0) {
    return csndJNI.csoundGet0dBFS(SWIGTYPE_p_CSOUND_.getCPtr(arg0));
  }

  public static double csoundGetA4(SWIGTYPE_p_CSOUND_ arg0) {
    return csndJNI.csoundGetA4(SWIGTYPE_p_CSOUND_.getCPtr(arg0));
  }
  ...
  public static String csoundGetInputName(SWIGTYPE_p_CSOUND_ arg0) {
    return csndJNI.csoundGetInputName(SWIGTYPE_p_CSOUND_.getCPtr(arg0));
  }
  ...
  public static void csoundGetOutputFormat(SWIGTYPE_p_CSOUND_ csound, String type, String format) {
    csndJNI.csoundGetOutputFormat(SWIGTYPE_p_CSOUND_.getCPtr(csound), type, format);
  }
  ...
  public static SWIGTYPE_p_double csoundGetInputBuffer(SWIGTYPE_p_CSOUND_ arg0) {
    long cPtr = csndJNI.csoundGetInputBuffer(SWIGTYPE_p_CSOUND_.getCPtr(arg0));
    return (cPtr == 0) ? null : new SWIGTYPE_p_double(cPtr, false);
  }

  public static SWIGTYPE_p_double csoundGetOutputBuffer(SWIGTYPE_p_CSOUND_ arg0) {
    long cPtr = csndJNI.csoundGetOutputBuffer(SWIGTYPE_p_CSOUND_.getCPtr(arg0));
    return (cPtr == 0) ? null : new SWIGTYPE_p_double(cPtr, false);
  }

  public static SWIGTYPE_p_double csoundGetSpin(SWIGTYPE_p_CSOUND_ arg0) {
    long cPtr = csndJNI.csoundGetSpin(SWIGTYPE_p_CSOUND_.getCPtr(arg0));
    return (cPtr == 0) ? null : new SWIGTYPE_p_double(cPtr, false);
  }

  public static void csoundClearSpin(SWIGTYPE_p_CSOUND_ arg0) {
    csndJNI.csoundClearSpin(SWIGTYPE_p_CSOUND_.getCPtr(arg0));
  }

  public static void csoundAddSpinSample(SWIGTYPE_p_CSOUND_ csound, int frame, int channel, double sample) {
    csndJNI.csoundAddSpinSample(SWIGTYPE_p_CSOUND_.getCPtr(csound), frame, channel, sample);
  }

  public static void csoundSetSpinSample(SWIGTYPE_p_CSOUND_ csound, int frame, int channel, double sample) {
    csndJNI.csoundSetSpinSample(SWIGTYPE_p_CSOUND_.getCPtr(csound), frame, channel, sample);
  }

  public static SWIGTYPE_p_double csoundGetSpout(SWIGTYPE_p_CSOUND_ csound) {
    long cPtr = csndJNI.csoundGetSpout(SWIGTYPE_p_CSOUND_.getCPtr(csound));
    return (cPtr == 0) ? null : new SWIGTYPE_p_double(cPtr, false);
  }

  public static double csoundGetSpoutSample(SWIGTYPE_p_CSOUND_ csound, int frame, int channel) {
  ...
  public static void csoundReadScoreAsync(SWIGTYPE_p_CSOUND_ csound, String str) {
    csndJNI.csoundReadScoreAsync(SWIGTYPE_p_CSOUND_.getCPtr(csound), str);
  }
  ...
  public static double csoundGetScoreOffsetSeconds(SWIGTYPE_p_CSOUND_ arg0) {
    return csndJNI.csoundGetScoreOffsetSeconds(SWIGTYPE_p_CSOUND_.getCPtr(arg0));
  }

  public static void csoundSetScoreOffsetSeconds(SWIGTYPE_p_CSOUND_ arg0, double time) {
  ...
  public static void csoundSetMessageStringCallback(SWIGTYPE_p_CSOUND_ csound, SWIGTYPE_p_f_p_CSOUND__int_p_q_const__char__void csoundMessageStrCallback) {
    csndJNI.csoundSetMessageStringCallback(SWIGTYPE_p_CSOUND_.getCPtr(csound), SWIGTYPE_p_f_p_CSOUND__int_p_q_const__char__void.getCPtr(csoundMessageStrCallback));
  }
  ...
  public static int csoundGetChannelPtr(SWIGTYPE_p_CSOUND_ arg0, SWIGTYPE_p_p_double p, String name, int type) {
    return csndJNI.csoundGetChannelPtr(SWIGTYPE_p_CSOUND_.getCPtr(arg0), SWIGTYPE_p_p_double.getCPtr(p), name, type);
  }
  ...
  public static double csoundGetControlChannel(SWIGTYPE_p_CSOUND_ csound, String name, SWIGTYPE_p_int err) {
    return csndJNI.csoundGetControlChannel(SWIGTYPE_p_CSOUND_.getCPtr(csound), name, SWIGTYPE_p_int.getCPtr(err));
  }

  public static void csoundSetControlChannel(SWIGTYPE_p_CSOUND_ csound, String name, double val) {
    csndJNI.csoundSetControlChannel(SWIGTYPE_p_CSOUND_.getCPtr(csound), name, val);
  }

  public static void csoundGetAudioChannel(SWIGTYPE_p_CSOUND_ csound, String name, SWIGTYPE_p_double samples) {
    csndJNI.csoundGetAudioChannel(SWIGTYPE_p_CSOUND_.getCPtr(csound), name, SWIGTYPE_p_double.getCPtr(samples));
  }

  public static void csoundSetAudioChannel(SWIGTYPE_p_CSOUND_ csound, String name, SWIGTYPE_p_double samples) {
    csndJNI.csoundSetAudioChannel(SWIGTYPE_p_CSOUND_.getCPtr(csound), name, SWIGTYPE_p_double.getCPtr(samples));
  }
  ...
  public static int csoundScoreEvent(SWIGTYPE_p_CSOUND_ arg0, char type, SWIGTYPE_p_double pFields, int numFields) {
    return csndJNI.csoundScoreEvent(SWIGTYPE_p_CSOUND_.getCPtr(arg0), type, SWIGTYPE_p_double.getCPtr(pFields), numFields);
  }

  public static void csoundScoreEventAsync(SWIGTYPE_p_CSOUND_ arg0, char type, SWIGTYPE_p_double pFields, int numFields) {
    csndJNI.csoundScoreEventAsync(SWIGTYPE_p_CSOUND_.getCPtr(arg0), type, SWIGTYPE_p_double.getCPtr(pFields), numFields);
  }

  public static int csoundScoreEventAbsolute(SWIGTYPE_p_CSOUND_ arg0, char type, SWIGTYPE_p_double pfields, int numFields, double time_ofs) {
    return csndJNI.csoundScoreEventAbsolute(SWIGTYPE_p_CSOUND_.getCPtr(arg0), type, SWIGTYPE_p_double.getCPtr(pfields), numFields, time_ofs);
  }

  public static void csoundScoreEventAbsoluteAsync(SWIGTYPE_p_CSOUND_ arg0, char type, SWIGTYPE_p_double pfields, int numFields, double time_ofs) {
    csndJNI.csoundScoreEventAbsoluteAsync(SWIGTYPE_p_CSOUND_.getCPtr(arg0), type, SWIGTYPE_p_double.getCPtr(pfields), numFields, time_ofs);
  }
  ...
  public static void csoundInputMessageAsync(SWIGTYPE_p_CSOUND_ arg0, String message) {
    csndJNI.csoundInputMessageAsync(SWIGTYPE_p_CSOUND_.getCPtr(arg0), message);
  }

  public static int csoundKillInstance(SWIGTYPE_p_CSOUND_ csound, double instr, String instrName, int mode, int allow_release) {
  ...
  public static double csoundTableGet(SWIGTYPE_p_CSOUND_ arg0, int table, int index) {
    return csndJNI.csoundTableGet(SWIGTYPE_p_CSOUND_.getCPtr(arg0), table, index);
  }

  public static void csoundTableSet(SWIGTYPE_p_CSOUND_ arg0, int table, int index, double value) {
    csndJNI.csoundTableSet(SWIGTYPE_p_CSOUND_.getCPtr(arg0), table, index, value);
  }

  public static void csoundTableCopyOut(SWIGTYPE_p_CSOUND_ csound, int table, SWIGTYPE_p_double dest) {
    csndJNI.csoundTableCopyOut(SWIGTYPE_p_CSOUND_.getCPtr(csound), table, SWIGTYPE_p_double.getCPtr(dest));
  }

  public static void csoundTableCopyOutAsync(SWIGTYPE_p_CSOUND_ csound, int table, SWIGTYPE_p_double dest) {
    csndJNI.csoundTableCopyOutAsync(SWIGTYPE_p_CSOUND_.getCPtr(csound), table, SWIGTYPE_p_double.getCPtr(dest));
  }

  public static void csoundTableCopyIn(SWIGTYPE_p_CSOUND_ csound, int table, SWIGTYPE_p_double src) {
    csndJNI.csoundTableCopyIn(SWIGTYPE_p_CSOUND_.getCPtr(csound), table, SWIGTYPE_p_double.getCPtr(src));
  }

  public static void csoundTableCopyInAsync(SWIGTYPE_p_CSOUND_ csound, int table, SWIGTYPE_p_double src) {
    csndJNI.csoundTableCopyInAsync(SWIGTYPE_p_CSOUND_.getCPtr(csound), table, SWIGTYPE_p_double.getCPtr(src));
  }

  public static int csoundGetTable(SWIGTYPE_p_CSOUND_ arg0, SWIGTYPE_p_p_double tablePtr, int tableNum) {
    return csndJNI.csoundGetTable(SWIGTYPE_p_CSOUND_.getCPtr(arg0), SWIGTYPE_p_p_double.getCPtr(tablePtr), tableNum);
  }

  public static int csoundGetTableArgs(SWIGTYPE_p_CSOUND_ csound, SWIGTYPE_p_p_double argsPtr, int tableNum) {
    return csndJNI.csoundGetTableArgs(SWIGTYPE_p_CSOUND_.getCPtr(csound), SWIGTYPE_p_p_double.getCPtr(argsPtr), tableNum);
  }

  public static int csoundIsNamedGEN(SWIGTYPE_p_CSOUND_ csound, int num) {
    return csndJNI.csoundIsNamedGEN(SWIGTYPE_p_CSOUND_.getCPtr(csound), num);
  }

  public static void csoundGetNamedGEN(SWIGTYPE_p_CSOUND_ csound, int num, String name, int len) {
    csndJNI.csoundGetNamedGEN(SWIGTYPE_p_CSOUND_.getCPtr(csound), num, name, len);
  }
  ...
  public static SWIGTYPE_p_void csoundCreateCondVar() {
    long cPtr = csndJNI.csoundCreateCondVar();
    return (cPtr == 0) ? null : new SWIGTYPE_p_void(cPtr, false);
  }

  public static void csoundCondWait(SWIGTYPE_p_void condVar, SWIGTYPE_p_void mutex) {
    csndJNI.csoundCondWait(SWIGTYPE_p_void.getCPtr(condVar), SWIGTYPE_p_void.getCPtr(mutex));
  }

  public static void csoundCondSignal(SWIGTYPE_p_void condVar) {
    csndJNI.csoundCondSignal(SWIGTYPE_p_void.getCPtr(condVar));
  }
  ...
  public static int csoundSpinLockInit(SWIGTYPE_p_spin_lock_t spinlock) {
    return csndJNI.csoundSpinLockInit(SWIGTYPE_p_spin_lock_t.getCPtr(spinlock));
  }

  public static void csoundSpinLock(SWIGTYPE_p_spin_lock_t spinlock) {
    csndJNI.csoundSpinLock(SWIGTYPE_p_spin_lock_t.getCPtr(spinlock));
  }

  public static int csoundSpinTryLock(SWIGTYPE_p_spin_lock_t spinlock) {
    return csndJNI.csoundSpinTryLock(SWIGTYPE_p_spin_lock_t.getCPtr(spinlock));
  }

  public static void csoundSpinUnLock(SWIGTYPE_p_spin_lock_t spinlock) {
    csndJNI.csoundSpinUnLock(SWIGTYPE_p_spin_lock_t.getCPtr(spinlock));
  }
