...
public class NavbarActivity extends AppCompatActivity
    ...
    private void requestPermissions() {
        Dexter.withActivity(NavbarActivity.this).withPermissions(
        ...
        task.addOnFailureListener(this, e -> {
            if (e instanceof ResolvableApiException) {
                ...
                try {
                    ...
                    resolvable.startResolutionForResult(NavbarActivity.this, REQUEST_CHECK_SETTINGS);
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.navigation_dashboard:
                switchFragment(ChartsFragment.newInstance(0));
                return true;
            case R.id.navigation_notifications:
                switchFragment(MapFragment.newInstance(0));
                return true;
        }
        return false;
    }
